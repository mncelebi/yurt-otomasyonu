...
public class OgrenciDuzenleGui extends JDialog {

	public OgrenciDuzenleGui() {
		initPencere();
	}
	...
	private JPanel initPanel() {
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (bulunanOgrenciDomain != null) {
					...
					textField_4.setText(bulunanOgrenciDomain.getVeliAdi());
					textField_5.setText(bulunanOgrenciDomain.getTelefon());
					textPane.setText(bulunanOgrenciDomain.getAdres());
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				OgrenciKayitDao.duzenle(kisiDomain);
				JOptionPane.showMessageDialog(null, "Güncelleme iþlemi baþarýlý");
